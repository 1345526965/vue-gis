<template>
  <div class="amap-page-container">
    ...
    <div class="toolbar">
      <button type="button" name="button" v-on:click="toggleVisible">
        toggle first marker
      </button>
      <button type="button" name="button" v-on:click="changePosition">
        change position
      </button>
      <button type="button" name="button" v-on:click="chnageDraggle">
        change draggle
      </button>
...
module.exports = {
  ...
  data() {
    return {
      ...
      renderMarker: {
        position: [121.5273285, 191.21715058],
